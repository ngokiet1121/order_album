<%@ Page Title="" Language="C#" MasterPageFile="~/Frontend/NoLeft.master" AutoEventWireup="true" CodeFile="ResetPass.aspx.cs" Inherits="Frontend_Login_Register" %>
                    ...
                    <div class="login-form">
                       ...
                       <fieldset>
                        <div class="control-group">
                            <div class="controls">
                                <asp:TextBox ID="txtEmail" CssClass="span6 typeahead" TextMode="Email" request  placeholder="Email" data-provide="typeahead" data-items="4" runat="server" ></asp:TextBox>                             
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                           <asp:Button ID="btnLogin" CssClass="btn btn-primary"
                                runat="server" Text="Reset Pass" OnClick="btnLogin_Click"/>
                        </div></br>
                         </fieldset>
                    </div>
                    <!--/login form-->
