<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Common/Backend.master" AutoEventWireup="true" CodeFile="EditStaff.aspx.cs" Inherits="Backend_Staff_EditStaff" %>
                ...
                <form id="Form1" class="form-horizontal" runat="server">
                    <fieldset>
                        ...
                        <div class="form-actions">
                            <asp:Button ID="btnEdit" CssClass="btn btn-primary" OnClick="btnEdit_Click" runat="server" Text="Add" />
