<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Common/Backend.master" AutoEventWireup="true" CodeFile="EditSong.aspx.cs" Inherits="Backend_Songs_EditSong" %>
                ...
                <form id="Form1" class="form-horizontal" runat="server">
                    <fieldset>
                        ...
                        <div class="form-actions">
                            <asp:Button ID="btnEdit" CssClass="btn btn-primary" OnClick="btnEdit_Click" runat="server" Text="Save changes" />
