<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/Common/Backend.master" AutoEventWireup="true" CodeFile="EditGroup.aspx.cs" Inherits="Backend_Groups_EditGroup" %>
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon white edit"></i><span class="break"></span>Form Edit Group</h2>
                <div class="box-icon">
                 ...
                 <form id="Form1" class="form-horizontal" runat="server">
                    <fieldset>
                        ...
                        <div class="form-actions">
                            <asp:Button ID="btnEdit" CssClass="btn btn-primary" OnClick="btnEdit_Click"
