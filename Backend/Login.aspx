            ...
            <div class="row-fluid">
                ...
                <div class="login-box">
                    <form runat="server" class="form-horizontal">
                        <div id="login">
                            <h2 id="h21">Login to your account</h2>
                            <fieldset>
                                <div class="input-prepend" id="Div1" title="Username">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <asp:TextBox ID="txtEmailLogin" CssClass="input-large span10" TextMode="Email" runat="server" required></asp:TextBox>
                                ...
                                <div class="input-prepend" title="Password">
                                    ...
                                    <asp:TextBox ID="txtPassword" CssClass="input-large span10" TextMode="Password" runat="server" required></asp:TextBox>
                                ...
                                <hr>
                                <h3><a href="ForgotPass.aspx">Forgot Password?</a></h3>
                                 </fieldset>
                        </div>
                        <div class="button-login">
                            <asp:Button ID="btnLogin" CssClass="btn btn-primary" OnClick="btnLogin_Click" runat="server" Text="Check" />
                        </div>
                        <div class="clearfix"></div>
                    </form>
                    <hr>
